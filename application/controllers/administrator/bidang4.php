...
class Bidang4 extends CI_Controller {
	...
	function index(){
        ...
        if($this->uri->segment(4)=="delete_success")
            ...
            $data['message']='';
            $this->load->template_admin('admin/kegiatan/index4',$data);
    }
        ...
        if($this->form_validation->run()==true){
            //$kegiatan=$this->input->post('kegiatan');
               //setting konfiguras upload image
                ...
                redirect('administrator/bidang4/index/add_success');
            } else{
            $data['message']="";
            $this->load->template_admin('admin/kegiatan/tambah4',$data);
        }
    }
    ...
    function edit($id){
        ...
        if($this->form_validation->run()==true){
            ...
            $this->load->template_admin('admin/kegiatan/edit4',$data);
        }else{
            $data['kegiatan']=$this->m_kegiatan->cekId($id)->row_array();
            $data['message']="";
            $this->load->template_admin('admin/kegiatan/edit4',$data);
