...
class User extends Ci_Controller {
    ...
    function index(){
        ...
        if($this->uri->segment(4)=="delete_success")
            ...
            $data['message']='';
            $this->load->template_admin('admin/user/index',$data);
    }
   ...
   function tambah(){
        ...
        if($this->form_validation->run()==true){
            ...
            if($cek->num_rows()>0){
                ...
                $this->load->template_admin('admin/user/tambah',$data);
            }else{
                $info=array(
                ...
                redirect('administrator/user/index/add_success');
            }
        }else{
            $data['message']="";
            $this->load->template_admin('admin/user/tambah',$data);
    ...
    function edit($id){
        ...
        if($this->form_validation->run()==true){
            ...
            $this->load->template_admin('admin/user/edit',$data);
        }else{
            $data['message']="";
            $data['user']=$this->m_user->cekId($id)->row_array();
            $this->load->template_admin('admin/user/edit',$data);;
