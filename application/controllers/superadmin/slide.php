...
class Slide extends CI_Controller {
	...
	function index(){
        ...
        if($this->uri->segment(3)=="delete_success")
            ...
            $data['message']='';
            $this->load->template_superadmin('superadmin/slide/index',$data);
    }
    ...
    function slide1(){
        ...
        //print_r($data['listSlide']);
            $this->load->template_superadmin('superadmin/slide/slide1',$data);
    }
    ...
    function slide2(){
        ...
        if($this->uri->segment(3)=="delete_success")
            ...
            $data['message']='';
        //print_r($data['listSlide']);
            $this->load->template_superadmin('superadmin/slide/slide2',$data);
    }
    ...
    function slide3(){
        ...
        if($this->uri->segment(3)=="delete_success")
            ...
            $data['message']='';
        //print_r($data['listSlide']);
            $this->load->template_superadmin('superadmin/slide/slide3',$data);
    }
    ...
    function tambah(){
        ...
        if($this->form_validation->run()==true){
            ...
            $data['message']="";
            $this->load->template_superadmin('superadmin/slide/tambah',$data);
        }
    }
    ...
    function edit($id){
        ...
        if($this->form_validation->run()==true){
            ...
            $data['slide']=$this->m_slide->cekId($id)->row_array();
           	$this->load->template_superadmin('superadmin/slide/edit',$data);
        }else{
            $data['slide']=$this->m_slide->cekId($id)->row_array();
            $data['message']="";
            $this->load->template_superadmin('superadmin/slide/edit',$data);
