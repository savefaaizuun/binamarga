...
class image_CRUD {
    ...
    protected function _get_delete_url($value)
    {
    	...
    	return site_url('administrator/'.$rsegments_array[1].'/'.$rsegments_array[2].'/delete_file/'.$value);
    }
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url('administrator/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file');
			$ajax_list_url  = site_url('administrator/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ajax_list');
			$ordering_url  = site_url('administrator/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url('administrator/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
