      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <div class="col-xs-2">
              <a href="<?php echo base_url()?>administrator/slide/tambah" class="btn btn-block btn-primary"> Add Slide</a>
            </div>
            </div><!-- /.box-header -->
            ...
            <?php echo $message;?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $no=0; foreach($listSlide as $slide): $no++;?>
                <tr>
                    <td><?php echo $no;?></td>
                    ...
                    <td>
                      ...
                      <a href="#" class="hapus"  slide_id="<?php echo $slide->slide_id;?>" ><button class="btn btn-app"><i class="fa fa-trash-o" > </i></button></a>
                    </td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
