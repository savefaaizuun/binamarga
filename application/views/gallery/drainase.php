...
<div id="main-content">
  ...
  <div class="panel-gallery">
    ...
    <div class="panel-foto">
      <div class="row">
        <?php foreach($listDrainase4->result_array() as $data){
        ?>
        <div class="col-xs-3">
          <div class="foto-baru">
            <a class="thumbnail-link" href="<?php echo base_url() ?>assets/uploads/<?php echo $data['url']; ?>" data-lightbox="foto-terbaru" ><img class="thumbnail" height="150px" width="100%" src="<?php echo base_url() ?>assets/uploads/<?php echo $data['url']; ?>" alt=""/></a>  
          </div>
        </div>
        <?php } ?>
      </div>
...
<div id="content">
  ...
  <div class="panel-gallery">
      <div class="panel-foto">
        ...
        <div class="row">
        <?php foreach($listDrainase as $data2){
        ?>
        <div class="col-xs-3">
          <div class="foto">
            <a class="thumbnail-link" href="<?php echo base_url() ?>assets/uploads/<?php echo $data2->url; ?>" data-lightbox="foto" ><img class="thumbnail" height="150px" width="100%" src="<?php echo base_url() ?>assets/uploads/<?php echo $data2->url; ?>" alt=""/></a>
          </div>
        </div>
        <?php } ?>          
        </div>
