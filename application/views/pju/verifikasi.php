	...
	<div class="panel-login">
		...
		<div class="row vertical-offset-100">
			<div class="panel-form">
				...
				<form class="form-horizontal" action="<?php echo base_url(); ?>pju/verifykode" method="post" enctype="multipart/form-data" />
				...
				<form class="form-horizontal" action="<?php echo base_url(); ?>pju/verifikasi" method="post" enctype="multipart/form-data" />
					<div class="row">
						<div class="col-sm-6">
