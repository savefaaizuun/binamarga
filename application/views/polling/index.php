...
<div id="content">
    ...
    <div class="panel-grafik">
        <div class="grafik">
            <div class="row">
                <div class="col-md-12">
                    <center><h3>Index Kepuasan Masyarakat Jalan</h3></center>
                    <br>
                    <div class="col-md-12">
                        
                        <div class="progress">
                            <div data-percentage="0%" style="width: <?php echo $persen_jalan ?>%;" class="progress-bar progress-bar-jalan" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
