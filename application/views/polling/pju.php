...
<html>
  ...
  <body>
    ...
    <div id="content" style="margin-top: 0px;">
      <div class="container">
        <h3 class="judul">INDEX KEPUASAN PJU</h3>
        <div class="row">
          <div class="col-sm-12">
            <form method="POST" action="<?php echo site_url(); ?>polling/votepju/<?php echo $this->uri->segment(3)+1 ; ?>">
                <?php echo "<p>".$QuestionPju['question']."</p>"; ?>
                <input type="hidden" name="question_id" value="<?php echo $QuestionPju['question_id'] ?>">
