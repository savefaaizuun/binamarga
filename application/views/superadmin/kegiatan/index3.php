      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <div class="col-xs-2">
              <a href="<?php echo base_url()?>superadmin/bidang3/tambah" class="btn btn-block btn-primary"> Add Kegiatan</a>
            </div>
            </div><!-- /.box-header -->
            <div class="box-body">
              <?php echo $message;?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-app" href="<?php echo site_url('superadmin/bidang3/edit/'.$kegiatan->kegiatan_id);?>" ><i class="fa fa-edit"> </i></a>
...
<script>
    $(function(){
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                url:"<?php echo site_url('superadmin/bidang3/hapus');?>",
                type:"POST",
                data:"kegiatan_id="+kegiatan_id,
                cache:false,
                success:function(html){
                    location.href="<?php echo site_url('superadmin/bidang3/index/delete_success');?>";
                }
            });
        });
    });
