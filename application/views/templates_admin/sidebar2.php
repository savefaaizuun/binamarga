        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url() ?>administrator/bidang1"><i class="fa fa-circle-o"></i> B. Perencanaan</a></li>
                <li><a href="<?php echo base_url() ?>administrator/bidang2"><i class="fa fa-circle-o"></i> B. Pemeliharaan</a></li>
                <li><a href="<?php echo base_url() ?>administrator/bidang3"><i class="fa fa-circle-o"></i> B. Pembangunan</a></li>
                <li><a href="<?php echo base_url() ?>administrator/bidang4"><i class="fa fa-circle-o"></i> B. Pengolahan & PJU</a></li>
                <li><a href="<?php echo base_url() ?>administrator/bidang5"><i class="fa fa-circle-o"></i> B. Pengendalian</a></li>
                <li><a href="<?php echo base_url() ?>administrator/bidang6"><i class="fa fa-circle-o"></i> B. Sekretariat</a></li>
              </ul>
            </li>
